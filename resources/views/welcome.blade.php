    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="{{route('front')}}" class="nav-link">Home</a></li>
                <li class="nav-item"><a href="{{route('posts.all')}}" class="nav-link">Articles</a></li>
                ...
                <div class="case">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-8 d-flex">
                            <a href="blog-single.html" class="img w-100 mb-3 mb-md-0" style="background-image: url({{asset('storage/'. $post->postimg)}});"></a>
                        </div>
